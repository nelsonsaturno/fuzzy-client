...
/**
 * Esto es un clon de FuzzyColumnSet, pero modificado para tratar con las
 * cosas referentes a los valores difusos tipos 2.
 * FIXME: Unificar FuzzyType2ColumnSet de alguna forma con FuzzyColumnSet.
 * FIXME-: Hay demasiada repetición entre estas dos clases.
 */
class FuzzyType2ColumnSet implements Iterable<FuzzyColumn> {
    ...
    FuzzyType2ColumnSet(Connector connector, TableRefList tableRefSet, PlainSelect plainSelect) throws Exception {
