 ...
 */
public class SelectType2Translator implements SelectVisitor, OrderByVisitor, SelectItemVisitor, FromItemVisitor {
    ...
    SelectType2Translator(Connector connector, AliasGenerator aliasGenerator) {
        this.connector = connector;
